...
describe("parse", function() {
    ...
    describe("operator expressions", function() {

        // unary operators
        // priority: primary > unary
        it("parses a unary +", function() {
            expect(parse("+3")()).toBe(3);
            expect(parse("+a")({a: 4})).toBe(4);
        });
        ...
        it("parses numerically negated value as contant if needed", function() {
        ...
        // altering precedence order with parentheses
